...
LANG_RU_EN_UZ =  {
  ...
  "Pers_area_hello": ["🪪 <b>Данный раздел позволяет получить результаты ваших анализов и приемов врачей.</b>\nДля входа сфотографируйте qr-код, либо введите идентификатор пользователя (синее поле) и код (красное поле) в виде: \n<b>12345678 12345678</b>",
                      "🪪 <b>In this section you can get the results of tests and doctor's visits.To enter, take a picture of the qr code or enter your user ID (blue field) and code (red field) as shown in the picture.\n<b>12345678 12345678</b>.",
  ...
  "Pers_area_appointment_nodata": ["За дату (D) документов не обнаружено.",
                                "No documents were found for date (D).",
